		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<table class="table table-hover table-bordered" id="deletetypes">
					...
					<s:iterator value="list" id="selectNum1">
						<tr style="height: 50px">
							...
							<td><a href="/Blog/text/updateType?id=${selectNum1.getId()}"><button
										type="button" class="btn btn-info">编辑</button></a></td>
							<td><button type="button" class="btn btn-success"
									onclick="DeleteType(${selectNum1.getId()})">删除</button></td>
						</tr>
					</s:iterator>
				</table>
				<nav>
				<ul class="pager">
					...
					<s:else>
						<li><a
							href="/Blog/text/allType?currentPage=<s:property value="currentPage-1"/>">Previous</a></li>
					</s:else>
					<s:if test="currentPage !=totalPage">
						<li><a
							href="/Blog/text/allType?currentPage=<s:property value="currentPage+1"/>">Next</a></li>
					</s:if>
					<s:else>
						<li><a href="#">Next</a></li>
					</s:else>
